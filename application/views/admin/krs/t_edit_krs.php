  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form role="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/krs/simpanupdate" onsubmit="return cekform();">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="kd_krs" id="kd_krs" placeholder="Masukan ID Mahasiswa" value="<?php echo $kd_krs; ?>" readonly>
              </div>
            </div>
            <div class="col-md-4">
            </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="id_mahasiswa" id="id_mahasiswa" placeholder="Masukan ID Mahasiswa" value="<?php echo $id_mahasiswa; ?>" readonly>
              </div>
            </div>
            <div class="col-md-4">
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <input type="text" class="form-control" name="kd_mata_kuliah" id="kd_mata_kuliah" placeholder="" value="<?php echo $kd_mata_kuliah; ?>">
            </div>
            <div class="col-md-7">
          ...
          <div class="row">
            ...
            <div class="col-md-1">
              <input type="text" class="form-control" name="total_sks" id="total_sks" placeholder="Total">
            </div>
            <div class="col-md-1">
            </div>
          </div><br>
