      ...
      <div class="panel-body">
        <form role="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/krs/simpan" onsubmit="return cekform();">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <select class="form-control" name="fakultas" id="fakultas">
                  ...
                  <?php
                  $fakultas = $this->m_krs->getlistfakultas();
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <select class="form-control" name="fakultas" id="fakultas">
                  ...
                  <?php
                  $jurusan = $this->m_krs->getlistjurusan();
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="nama_mahasiswa" id="nama_mahasiswa" placeholder="Masukan Nama Mahasiswa">
              </div>
            </div>
            <div class="col-md-4">
              <div class="input-group">
                ...
                <select class="form-control" name="jenjang" id="jenjang">
                  ...
                  <?php
                  $jenjang = $this->m_krs->getlistjenjang();
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <input type="text" class="form-control" name="kd_mata_kuliah1" id="kd_mata_kuliah1" placeholder="">
            </div>
            <div class="col-md-7">
              <input type="text" class="form-control" placeholder="">
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <input type="text" class="form-control" name="kd_mata_kuliah2" id="kd_mata_kuliah2" placeholder="">
            </div>
            <div class="col-md-7">
              <input type="text" class="form-control" placeholder="">
            </div>
