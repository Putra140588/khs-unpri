	      ...
	      <div class="alert" id="alert" style="display:none" role="alert"><?php echo $this->session->flashdata('info')?></div>
	        ...
	        <p><a href="<?php echo base_url(); ?>mahasiswa/tambah" type="button" class="btn btn-primary">Tambah</a></p>
	          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<?php
								$no = 1;
								foreach ($krs_mahasiswa->result() as $row) {
								...
								<td>
								<a href="<?php echo base_url(); ?>krs/nilai_khs/<?php echo $row->nim.'/'.$row->semester; ?>" type="button" class="btn btn-info btn-xs">Detail Khs</a>
                 				<a href="<?php echo base_url(); ?>krs/detail_krs_mahasiswa/<?php echo $row->nim.'/'.$row->semester; ?>" type="button" class="btn btn-primary btn-xs">Detail Krs</a>
