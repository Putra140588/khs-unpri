          ...
          <P><?php
			    ...
			    <div class="panel-body">
			      <div class="dataTable_wrapper">
			      	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/mahasiswa/simpanupdate" onsubmit="return cekform();">
			          <div class="form-group">
			          <label class="control-label col-sm-4">ID Mahasiswa</label>
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="id_mahasiswa" id="id_mahasiswa" placeholder="Id Mahasiswa" value="<?php echo $id_mahasiswa; ?>" readonly>
			              </div>
			            </div>
			          </div>
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="nama_mahasiswa" id="nama_mahasiswa" placeholder="Nama Mahasiswa" autofocus="" value="<?php echo $nama_mahasiswa; ?>">
			              </div>
			            </div>
			          </div>
			          ...
			          <label class="control-label col-sm-4">Jenis Kelamin</label>
	                      ...
	                      <option selected disabled ><?php echo $jenis_kelamin; ?></option>
			          ...
			          <label class="control-label col-sm-4">Agama</label>
	                      ...
	                      <option selected disabled><?php echo $agama; ?></option>
			          ...
			          <label class="control-label col-sm-4">Jenjang</label>
	                      ...
	                      <option selected disabled><?php echo $kd_jenjang; ?></option>
	                      <?php
