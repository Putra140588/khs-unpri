          ...
          <P><?php
			    ...
			    <div class="panel-body">
			      <div class="dataTable_wrapper">
			      	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/nilai_uts/simpanupdate" onsubmit="return cekform();">

			          <div class="form-group">
			          <label class="control-label col-sm-4">Kode Nilai UTS</label>
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="kd_nilai_uts" id="kd_nilai_uts" placeholder="Kode Nilai UTS" value="<?php echo $kd_nilai_uts; ?>" readonly>
			              </div>
			            </div>
			          </div>
                	...
                	<a href="<?php echo base_url(); ?>admin/nilai_uts" type="submit" class="btn btn-warning">Tutup</a>
