          ...
          <P><?php
			    ...
			    <div class="panel-body">
			      <div class="dataTable_wrapper">
			      	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/kelas_program/simpanupdate" onsubmit="return cekform();">
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="kd_kelas_program" id="kd_kelas_program" placeholder="Kode Kelas Program" value="<?php echo $kd_kelas_program ?>" readonly>
			              </div>
			            </div>
			          </div>
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="kelas_program" id="kelas_program" placeholder="Nama Kelas Program" autofocus="" value="<?php echo $kelas_program ?>">
			              </div>
			            </div>
			          </div>
