<script type="text/javascript">
	function cekform() {
		...
		if(!$("#kd_jenjang").val()) {
			alert('Kode Jenjang tidak boleh kosong');
			$("#kd_jenjang").focus()
			return false;
		}
          ...
          <P><?php
			    ...
			    <div class="panel-body">
			      <div class="dataTable_wrapper">
			      	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/jenjang/simpan" onsubmit="return cekform();">
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="kd_jenjang" id="kd_jenjang" placeholder="Kode Jenjang" autofocus="">
			              </div>
			            </div>
			          </div>
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-education" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="jenjang" id="jenjang" placeholder="Nama Jenjang">
			              </div>
			            </div>
			          </div>
