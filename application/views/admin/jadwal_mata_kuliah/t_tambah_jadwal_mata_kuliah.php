          ...
          <P><?php
			    ...
			    <div class="panel-body">
			      <div class="dataTable_wrapper">
			      	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/jadwal_mata_kuliah/simpan" onsubmit="return cekform();">
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="id_dosen" id="id_dosen" placeholder="ID Dosen Pengajar">
			              </div>
			            </div>
			          </div>
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-play" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="waktu_mulai" id="waktu_mulai" placeholder="ex. 19:00">
			              </div>
			            </div>
			          </div>
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-stop" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="waktu_selesai" id="waktu_selesai" placeholder="ex. 21:00">
			              </div>
			            </div>
			          </div>
