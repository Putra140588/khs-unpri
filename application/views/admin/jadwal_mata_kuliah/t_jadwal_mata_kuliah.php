<div class="row">
  <div class="col-lg-12">
      ...
      <div class="panel-body">
        ...
        <p><a href="<?php echo base_url(); ?>admin/jadwal_mata_kuliah/tambah" type="button" class="btn btn-primary">Tambah</a></p>
          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
							...
							?>
								...
								<td>
									<a href="<?php echo base_url(); ?>admin/jadwal_mata_kuliah/edit/<?php echo $row->kd_jadwal; ?>" type="button" class="btn btn-warning btn-xs">Edit</a>
                  <a href="<?php echo base_url(); ?>admin/jadwal_mata_kuliah/delete/<?php echo $row->kd_jadwal; ?>" type="button" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin ingin menghapus data ini?');">Hapus</a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
