          ...
          <P><?php
			    ...
			    <div class="panel-body">
			      <div class="dataTable_wrapper">
			      	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>dosen/nilai_tugas/simpan" onsubmit="return cekform();">
			            ...
			            <div class="col-sm-4">
			              <div class="input-group">
			                <span class="input-group-addon"><span class="glyphicon glyphicon-book" aria-hidden="true"></span></span>
			               	<input type="text" class="form-control" name="nilai" id="nilai" placeholder="Nilai" value="<?php echo $nilai; ?>" autofocus="">
			              </div>
			            </div>
			          </div>
                	...
                	<a href="<?php echo base_url(); ?>dosen/nilai_tugas" type="submit" class="btn btn-warning">Tutup</a>
